...
export const CATEGORIES: MenuCategory[] = [
  ...
  { id: 'salads', label: 'Salads', sortOrder: 2 },
  { id: 'tacos', label: 'Tacos', sortOrder: 3 },
  { id: 'burgers', label: 'Burgers', sortOrder: 4 },
  { id: 'sandwiches', label: 'Sandwiches', sortOrder: 5 },
  { id: 'soups', label: 'Soups', sortOrder: 6 },
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    name: 'Quesadilla',
    description:
      'Chicken, pico de gallo, pepper jack, tortillas, sour cream, salsa.',
    price: usd(900),
    tags: [],
    allergens: ['dairy'],
    spicy: 2,
    featured: true,
    image: { src: '/images/quesadilla.jpg', alt: 'Quesadilla' },
  },
  {
    id: 'app-fries',
    categoryId: 'appetizers',
  ...
  // Salads
  {
    id: 'salad-summer-blend',
    categoryId: 'salads',
    name: 'Summer Blend Salad',
    description:
      'Grilled chicken, spring mix + fresh greens, red onion, apple, strawberries, celery, candied pecans, goat cheese, balsamic vinaigrette.',
    price: usd(850),
    tags: ['GF'],
    allergens: ['dairy'],
    spicy: 1,
    image: { src: '/images/salad-summer.jpg', alt: 'Summer Blend Salad' },
  },
